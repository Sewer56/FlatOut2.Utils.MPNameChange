...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "FlatOut2.Utils.MPNameChange/FlatOut2.Utils.MPNameChange.csproj",
    $PackageName = "FlatOut2.Utils.MPNameChange",
    ...
    $NuGetPackageId = "FlatOut2.Utils.MPNameChange",
